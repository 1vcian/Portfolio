...
\begin{tabular}{@{}p{0.1\textwidth}p{0.9\textwidth}@{}}
  ...
  \begin{itemize}[leftmargin=1em]
    \item \textcolor{linkcolor}{\textbf{Bug Bounty Hunter}}: Scoperto 2 vulnerabilità critiche RCE (CVSS 10.0) su un importante distributore internet italiano tramite Cyberdart.eu, guadagnando ~$5.000 in bounty
...
\begin{minipage}[t]{0.65\textwidth}
  ...
  \experienceitem{Ingegnere Software Full Stack}{Tiuke}{Ott 2019 - Giu 2025}{Roma, Italia}{
  ...
  \vspace{0.25cm}
  \begin{center}
    \textit{Visualizza altri progetti su GitHub: \href{https://github.com/1vcian}{github.com/1vcian}}
  \end{center}
