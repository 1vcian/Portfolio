      ...
      >
        ...
        <div className="w-full flex flex-col md:flex-row space-y-8 md:space-y-0  md:space-x-8 sm:space-x-2 ">
          <div className="w-full md:w-7/12 space-y-4 sm:text-base text-sm ">
            ...
            <div className="font-Header text-justify">
              <span className="text-gray-400 ">
                Throughout my career, I have worked at a company where I gained diverse experience across different domains from
                GIS applications to management systems and machine learning projects focusing on image processing and LLMs. I have
                contributed to projects for the <span className="text-AAsecondary">Italian Ministry of Agriculture</span> and
                participated in some <span className="text-AAsecondary">ESA</span> projects. During my Computer Engineering studies, I won the{" "}
                <span className="text-AAsecondary">Google Workshop</span> where I developed a university notes social network,
